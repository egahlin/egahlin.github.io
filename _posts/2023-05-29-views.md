...
The **view** command can also be used against a recording file. A file can be created by setting a filename with **-XX:StartFlightRecording** option. The contents are dumped when the JVM exits. 
