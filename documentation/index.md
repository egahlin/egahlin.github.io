...
[Javadoc jdk.jfr](https://docs.oracle.com/en/java/javase/20/docs/api/jdk.jfr/module-summary.html)

[Javadoc jdk.management.jfr](https://docs.oracle.com/en/java/javase/20/docs/api/jdk.management.jfr/module-summary.html)

[jcmd JFR.start](https://docs.oracle.com/en/java/javase/20/docs/specs/man/jcmd.html)

[-XX:StartFlightRecording and -XX:FlightRecorderOptions](https://docs.oracle.com/en/java/javase/16/docs/specs/man/java.html)

[jfr tool](https://docs.oracle.com/en/java/javase/20/docs/specs/man/jfr.html)
